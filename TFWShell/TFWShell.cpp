...
double TFWShell::computeAmplitudesFromQuad(int faceId, int quadId, Eigen::Vector2d* da, Eigen::Vector3d* gradA, Eigen::Matrix<double, 2, 3>* gradDA, Eigen::Matrix<double, 3, 3>* hessianA, std::vector<Eigen::Matrix<double, 3, 3>>* hessianDA)
{
	Eigen::Vector3d amps;
...
Eigen::Vector2d TFWShell::computeDphi(int faceId, Eigen::Matrix<double, 2, 3>* gradDphi)
{
...
Eigen::Matrix2d TFWShell::computeDaDphiTensor(int faceId, int quadId, std::vector<Eigen::Matrix2d>* deriv, std::vector<Eigen::Matrix<double, 6, 6>>* hessian)
{
...
Eigen::Matrix2d TFWShell::computeDphiDaTensor(int faceId, int quadId, std::vector<Eigen::Matrix2d>* deriv, std::vector<Eigen::Matrix<double, 6, 6>>* hessian)
{
...
Eigen::Matrix2d TFWShell::computeDaDaTensor(int faceId, int quadId, std::vector<Eigen::Matrix2d>* deriv, std::vector<Eigen::Matrix<double, 3, 3>>* hessian)
{
	Eigen::Vector2d da;
	Eigen::Vector3d gradA;
...
Eigen::Matrix2d TFWShell::computeDphiDphiTensor(int faceId, int quadId, std::vector<Eigen::Matrix2d>* deriv, std::vector<Eigen::Matrix<double, 3, 3>>* hessian)
{
	Eigen::Vector2d dphi;
...
std::vector<Eigen::Matrix2d> TFWShell::computeStretchingDensityFromQuad(int faceId, int quadId, std::vector<Eigen::MatrixXd >* deriv, std::vector<std::vector<Eigen::MatrixXd>>* hessian)
{
...
std::vector<Eigen::Matrix2d> TFWShell::computeBendingDensityFromQuad(int faceId, int quadId, std::vector<Eigen::MatrixXd >* deriv, std::vector<std::vector<Eigen::MatrixXd>>* hessian)
{
	std::vector<Eigen::Matrix2d> Mats;
...
double TFWShell::stretchingEnergyPerface(int faceId, Eigen::VectorXd* deriv, Eigen::MatrixXd* hessian)
{
	double lameAlpha = _setup.YoungsModulus * _setup.PoissonsRatio / (1.0 - _setup.PoissonsRatio * _setup.PoissonsRatio);
	double lameBeta = _setup.YoungsModulus / 2.0 / (1.0 + _setup.PoissonsRatio);
//    lameBeta = 0;
...
double TFWShell::bendingEnergyPerface(int faceId, Eigen::VectorXd* deriv, Eigen::MatrixXd* hessian)
{
	double lameAlpha = _setup.YoungsModulus * _setup.PoissonsRatio / (1.0 - _setup.PoissonsRatio * _setup.PoissonsRatio);
	double lameBeta = _setup.YoungsModulus / 2.0 / (1.0 + _setup.PoissonsRatio);
	// lameBeta = 0;
...
double TFWShell::stretchingEnergy(Eigen::VectorXd* deriv, Eigen::SparseMatrix<double>* hessian)
{
...
double TFWShell::bendingEnergy(Eigen::VectorXd* deriv, Eigen::SparseMatrix<double>* hessian)
{
	int nfaces = _state.baseMesh.nFaces();
	int nverts = _state.basePos.rows();
	int nedges = _state.baseMesh.nEdges();
...
double TFWShell::elasticReducedEnergy(Eigen::VectorXd* deriv, Eigen::SparseMatrix<double>* hessian)
{
...
Eigen::VectorXd TFWShell::computeStretchingEnergyTermByTerm()
{
	double lameAlpha = _setup.YoungsModulus * _setup.PoissonsRatio / (1.0 - _setup.PoissonsRatio * _setup.PoissonsRatio);
	double lameBeta = _setup.YoungsModulus / 2.0 / (1.0 + _setup.PoissonsRatio);
	//    lameBeta = 0;
...
Eigen::VectorXd TFWShell::computeBendingEnergyTermByTerm()
{
	double lameAlpha = _setup.YoungsModulus * _setup.PoissonsRatio / (1.0 - _setup.PoissonsRatio * _setup.PoissonsRatio);
	double lameBeta = _setup.YoungsModulus / 2.0 / (1.0 + _setup.PoissonsRatio);
	//    lameBeta = 0;
...
void TFWShell::testAmplitudesFromQuad(int faceId, int quadId)
{
...
void TFWShell::testDphi(int faceId)
{
	Eigen::Matrix<double, 2, 3> gradDphi;
...
void TFWShell::testStretchingDensityFromQuad(int faceId, int quadId)
{
...
void TFWShell::testBendingDensityFromQuad(int faceId, int quadId)
{
	std::vector<Eigen::MatrixXd > deriv;
	std::vector<std::vector<Eigen::MatrixXd>> hessian;
...
void TFWShell::testStretchingEnergyPerface(int faceId)
{
...
void TFWShell::testBendingEnergyPerface(int faceId)
{
	auto backupPosHess = _isPosHess;
	_isPosHess = false;
...
void TFWShell::testStretchingEnergy()
{
	auto backupPosHess = _isPosHess;
	_isPosHess = false;
...
void TFWShell::testBendingEnergy()
{
	auto backupPosHess = _isPosHess;
	_isPosHess = false;
...
void TFWShell::testElasticReducedEnergy()
{
	auto backupPosHess = _isPosHess;
	_isPosHess = false;
